...
import Leeanne_image from '../images/photos/leeanne_image.jpg'
...
export default function Home() {
  const socialLinks = [
    {
      href: 'https://www.instagram.com/_girl_coach_/',
      icon: InstagramIcon,
    },
    // {
  ...
  const linksData = [
    {
      ...
      description:
        "In a world that feels so out of control, it's time to take your life and mental well-being back!",
      href: 'https://www.girlandco.me/',
      image: null,
      icon: TbWorld,
    },
    {
      title: 'Book A Kickstart Session',
      description:
        'Meet with your coach 1:1, virtually to work together on your unique success plan.',
      href: 'https://www.girlandco.me/booking',
      image: Coaching,
      icon: null,
    },
    {
      title: 'Meet Leeanne',
      description:
        'Leeanne is a Licensed Counselor, Coach, Certified Teacher, and Mom.',
      href: 'https://www.girlandco.me/meetleeanne',
      image: Logo,
      icon: null,
    },
    {
      title: 'Our Programs',
      description: 'We offer a variety of programs to help you.',
      href: 'https://www.girlandco.me/challenges',
      image: null,
      icon: TbListDetails,
    },
    {
          ...
          <div className="relative w-full">
            ...
            <div className="relative z-30">
              ...
              <p className="mb-8 px-6 text-sm text-white/80">
                Licensed Counselor, Coach, Certified Teacher, &Mom
              </p>
